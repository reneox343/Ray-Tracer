...
public class Camera extends Object3D {
    ...
    /**
     * @param position is used to set the position of the camara
     * @param fieldOfViewVertical is used to set the vertical field of view of the camara
     * @param fieldOfViewHorizontal is used to set the horizontal field of view of the camara
     * @param widthResolution is used to determine the amount of pixels in the width
     * @param heightResolution is used to determine the amount of pixels in the height
     * @param nearPlane is used to set the minimum distance of the intersections
     * @param farPlane is used to set the max distance of the intersections
     * */
    ...
    /**
     * @return the positions of the rays of the camera
     * */
